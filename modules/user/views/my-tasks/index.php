            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="tools pull-right">
                        <a href="#task-add-form" data-toggle="modal" data-target="#task-add-form" class="btn btn-success btn-lg">Добавить задание</a>

                        <!-- Modal -->
                        <div class="modal fade" id="task-add-form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
